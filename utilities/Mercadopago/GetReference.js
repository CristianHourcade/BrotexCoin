...
export function GetUrlToPay(monto){
    return new Promise(resolve => {
        ...
        xhttp.send(JSON.stringify({items:[{title:"Brotex Coin", description:"Tu moneda digital", quantity:1,currency_id:'ARS',unit_price:Number(monto)}]}));
    });
}